...
class KanungoNoise:
    def __init__(
        ...
        alpha -- controls the probability of a foreground pixel flip
        (default = 2.0)
        alpha_0 --  controls the probability of a foreground pixel flip
        (default = 1.0)
        beta -- controls the probability of a background pixel flip
        (default = 2.0)
        beta_0 -- controls the probability of a background pixel flip
        (default = 1.0)
        mu -- constant probability of flipping for all pixels
        (default = 0.05)
        k -- diameter of the disk structuring element for the closing operation
        (default = 2)
