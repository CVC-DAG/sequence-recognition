...
class ComrefSeq2SeqExperimentConfig(ExperimentConfig):
...
class ComrefSeq2SeqExperiment(Experiment):
    """Object modelling the Experiment with Arnau Baró's CRNN model."""

    EXPERIMENT_CONFIG = ComrefSeq2SeqExperimentConfig
